...
def create_Dynamic_xml(Object_list, fp_out):
...
create_Dynamic_xml(json1_object_list, Output_XML_fp)  # Controller function to render changes over default template and produce XML with user given name 
